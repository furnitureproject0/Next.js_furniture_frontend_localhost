	...
	return (
		<div className="min-h-screen relative overflow-hidden" style={{ background: "#F8FAFC" }}>
			...
			<div className="relative p-4 sm:p-6 lg:p-8 z-10">
				...
				{/* Tab Navigation */}
				<div className="bg-white/90 backdrop-blur-md rounded-t-2xl border border-primary-200/50 shadow-xl overflow-hidden">
				...
				{/* Tab Content with Scale-In Animation */}
				<div className="bg-white/95 backdrop-blur-md rounded-b-2xl border border-t-0 border-primary-200/50 shadow-2xl overflow-hidden min-h-[400px]">
					<div key={activeTab} className="animate-scale-in origin-top">
