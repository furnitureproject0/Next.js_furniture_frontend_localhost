...
import { selectSiteAdminOrdersStats } from "@/store/selectors";
...
export default function SiteAdminStatsCards() {
	const { t } = useTranslation();
	const stats = useAppSelector(selectSiteAdminOrdersStats);
