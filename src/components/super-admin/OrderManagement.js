		...
		<div className="p-4 sm:p-6 lg:p-8 space-y-6 sm:space-y-8">
			...
			<div className="space-y-4">
				<h3 className="text-lg font-bold text-slate-800 flex items-center gap-2">
					...
					{t("superAdmin.dashboard.overview") || "Daily Overview"}
				</h3>
				...
				<div className="space-y-4 pt-6 border-t border-primary-100">
					<div className="flex items-center justify-between">
						<h3 className="text-base sm:text-lg font-semibold text-slate-800">
							{t("superAdmin.orderManagement.allOrders")}
						</h3>
						<span className="px-3 py-1 bg-primary-100 text-primary-700 rounded-full text-xs font-bold">
							{t("common.countWithLabel", { count: filteredOrders.length, label: t("common.items") })}
						</span>
					</div>
