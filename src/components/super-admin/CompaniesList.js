		...
		>
			...
			<div className="relative flex items-start justify-between z-10">
				...
				<div className="flex items-start gap-6 flex-1">
					<div className={`relative w-20 h-20 ${getGradientByType(company.type)} rounded-2xl flex items-center justify-center shadow-xl flex-shrink-0 group-hover/card:scale-110 group-hover/card:rotate-3 transition-all duration-500 border-2 border-white/20 animate-shine`}>
					...
					<div className="flex-1 min-w-0">
						<div className="flex items-center gap-3 mb-2.5">
							...
							<div className="relative">
								...
								>
									<span className={`inline-block w-1.5 h-1.5 rounded-full mr-1.5 ${company.available ? 'bg-green-500 animate-pulse' : 'bg-gray-400'}`}></span>
						...
						<div className="flex flex-wrap gap-3">
							<div className="px-3 py-1.5 rounded-lg bg-slate-50 border border-slate-100 flex items-center gap-2 group/tag">
								<span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">{t("superAdmin.companyDetails.type")}:</span>
							...
							<div className="px-3 py-1.5 rounded-lg bg-slate-50 border border-slate-100 flex items-center gap-2 group/tag">
								<span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">{t("superAdmin.companyDetails.services")}:</span>
