...
export default function PeriodSummary({ stats }) {
	...
	return (
		<div className="bg-white/80 backdrop-blur-sm rounded-xl border border-primary-200/60 shadow-lg p-4 sm:p-5 lg:p-6">
			<h3 className="text-base sm:text-lg font-semibold text-slate-800 mb-4 sm:mb-5 lg:mb-6">
