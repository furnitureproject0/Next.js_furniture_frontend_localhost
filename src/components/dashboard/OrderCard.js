...
const OrderHeader = ({ order, t }) => (
	<div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0 mb-3 sm:mb-4">
		<div className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
			<div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-primary-50 to-primary-50 rounded-lg sm:rounded-xl flex items-center justify-center flex-shrink-0">
...
const OrderDetails = ({ order, t }) => (
	<div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-3 sm:mb-4">
		<div className="space-y-2 sm:space-y-3">
			<div>
				<p className="text-xs font-medium text-primary-600/70 uppercase tracking-wide mb-0.5 sm:mb-1">
			...
			<div className="flex flex-wrap items-center gap-4 sm:gap-6">
				<div>
					...
					<div className="flex items-center gap-1">
						<svg
							className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary-600/60 flex-shrink-0"
							fill="none"
							stroke="currentColor"
							viewBox="0 0 24 24"
						>
					...
					<div className="flex items-center gap-1">
						{order.cleaning ? (
							...
							<>
								...
								<span className="text-xs sm:text-sm font-semibold text-slate-600/70">
									{t("orderDetails.no")}
								</span>
							</>
						)}
		...
		<div>
			...
			<div className="flex items-start gap-1.5 sm:gap-2">
				<svg
					className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary-600/60 mt-0.5 flex-shrink-0"
					fill="none"
					stroke="currentColor"
					viewBox="0 0 24 24"
				>
...
const TeamAssignment = ({ order, t }) => {
	...
	return (
		<div className="mb-3 sm:mb-4 p-2.5 sm:p-3 bg-primary-50/60 rounded-lg">
			...
			<div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-4">
				<div className="flex items-center gap-1.5 sm:gap-2">
					<svg
						className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary-500 flex-shrink-0"
						fill="none"
						stroke="currentColor"
						viewBox="0 0 24 24"
					>
...
const OrderActions = ({
	...
	t,
		...
		<div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2 sm:gap-0 pt-2 sm:pt-3 border-t border-primary-100/50">
		...
		<div className="flex items-center gap-2">
			<button className="px-2.5 sm:px-3 py-1.5 sm:py-2 text-xs sm:text-sm text-slate-600 hover:text-slate-800 font-medium transition-colors flex items-center gap-1.5 sm:gap-2">
				<svg
					className="w-3.5 h-3.5 sm:w-4 sm:h-4"
					fill="none"
					stroke="currentColor"
...
export default function OrderCard({
	...
	return (
		<div className="group border border-primary-200/60 rounded-xl p-4 sm:p-5 hover:shadow-lg hover:border-primary-300/60 transition-all duration-200 bg-white/60 backdrop-blur-sm">
